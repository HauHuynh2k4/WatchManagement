 ...
 * @author ADMIN
 */
@WebServlet(name = "SearchWatchByIdOrName", urlPatterns = {"/SearchWatchByIdOrName"})
public class SearchWatchByIdOrName extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String search = request.getParameter("IdOrName");      
            WatchDAO dao = new WatchDAO();
            List<WatchDTO> listWatch = dao.searchWatchByIdOrName(search);
            if(listWatch.size()>0){
