 ...
 * @author ADMIN
 */
@WebServlet(name = "SearchWatchByType", urlPatterns = {"/SearchWatchByType"})
public class SearchWatchByType extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<WatchDTO> listWatch = dao.searchWatchByType(search);
            if(listWatch.size()>0){
