<%-- 
    Document   : ManageWatch
    Created on : Jun 22, 2024, 5:56:15 PM
    Author     : ADMIN
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/ManageWatch.css">
    </head>
    <body>
                ...
                <div class="products">
                    ...
                    <div class="product">
                        ...
                        <form action="MainController" method="post">
                            ...
                            <button type="submit" name="action" value="Update Watch">Update</button>
                        </form>
                        <form action="MainController" method="post" onsubmit="return confirm('Are you sure you want to delete this watch?');">
                            <input type="hidden" name="watchId" value="<%= watch.getWatchId()%>">
                            <button type="submit" name="action" value="Delete Watch">Delete</button>
                        </form>
                    </div>
                    <%
                        }
